...
Welcome to `classify_covid` contributor's guide.
...
If you experience bugs or general issues with `classify_covid`, please have a look
...
You can help improve `classify_covid` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`classify_covid` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `classify_covid`'s files. While this mechanism can
...
```
conda create -n classify_covid python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/classify_covid.git
   cd classify_covid
   ```
...
5. Install [pre-commit]:
   ...
   `classify_covid` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/classify_covid
[issue tracker]: https://github.com/<USERNAME>/classify_covid/issues
